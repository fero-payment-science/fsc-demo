...
export const shippingRates: ShippingRate[] = [
  {
    rate_id: "flat_rate:2",
    method_id: "flat_rate",
    label: "Standard Shipping (7-15 business days)",
    cost: "550",
    total: "5.50",
    taxes: [],
    shipping_tax: 0,
  ...
  },
  {
    rate_id: "flat_rate:1",
    method_id: "flat_rate",
    label: "Express Delivery (48-72 hours)",
    cost: "1550",
    total: "15.50",
    taxes: [],
    shipping_tax: 0,
...
export const countries: CountryObject[] = [
  ...
  { alpha2: "BQ", name: "Bonaire, Saint Eustatius and Saba" },
  ...
  { alpha2: "CG", name: "Congo (Brazzaville)" },
  { alpha2: "CD", name: "Congo (Kinshasa)" },
  ...
  { alpha2: "FK", name: "Falkland Islands" },
  ...
  { alpha2: "PS", name: "Palestinian Territory" },
  ...
  { alpha2: "GS", name: "South Georgia/Sandwich Islands" },
  ...
  { alpha2: "GB", name: "United Kingdom (UK)" },
  { alpha2: "US", name: "United States (US)" },
  { alpha2: "UM", name: "United States (US) Minor Outlying Islands" },
  { alpha2: "UY", name: "Uruguay" },
  { alpha2: "UZ", name: "Uzbekistan" },
  { alpha2: "VU", name: "Vanuatu" },
  { alpha2: "VA", name: "Vatican" },
